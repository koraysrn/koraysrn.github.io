...
export default function About() {
  return (
    <Container className="mt-20">
      <SectionHeading subHeading="About me" heading="Me" />
      {/* About me */}
        ...
        <div className="mt-4">
          ...
          <div className="flex flex-wrap gap-2">
            {mySkills.map((skill) => (
              <span
                key={skill}
                className="mt-4 inline-flex items-center rounded-md border border-dashed border-black/20 bg-black/5 px-2 py-1 text-sm text-black dark:border-white/30 dark:bg-white/15 dark:text-white"
              >
                {skill}
              </span>
            ))}
